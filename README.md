...
- **CONFIGURATION REQUIRED:** A real crypto provider webhook and destination/rate configuration. The trading provider adapter remains unavailable until a real server-side broker adapter and credentials are supplied.
